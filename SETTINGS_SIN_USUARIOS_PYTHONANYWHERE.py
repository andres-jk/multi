# settings.py SIN USUARIOS para PythonAnywhere - VERSIÓN ESTABLE
...
# Application definition - SIN USUARIOS para evitar conflictos
INSTALLED_APPS = [
    ...
    # 'usuarios',  # Comentado temporalmente para evitar conflictos
    'productos',
    'pedidos',
    'recibos',
    'chatbot',
...
print("✅ Settings SIN USUARIOS configurado correctamente para PythonAnywhere")

# settings.py ULTRA SIMPLE para PythonAnywhere
# Copia TODO este contenido y reemplaza completamente tu settings.py

import os

# Build paths - usando ruta absoluta para evitar problemas
...
# CSRF settings para PythonAnywhere
CSRF_TRUSTED_ORIGINS = [
    'https://dalej.pythonanywhere.com',
]

print("✅ Settings ULTRA SIMPLE configurado correctamente para PythonAnywhere")
